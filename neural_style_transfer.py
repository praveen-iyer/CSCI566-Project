...
if __name__ == "__main__":
    ...
    parser.add_argument("--content_img_name", type=str, help="content image name", default='amber.jpg')
    parser.add_argument("--style1_img_name", type=str, help="style1 image name", default='mosaic.jpg')
    parser.add_argument("--style2_img_name", type=str, help="style2 image name", default='udnie.jpg')
