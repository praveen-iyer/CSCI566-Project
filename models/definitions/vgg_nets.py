...
class Vgg16(torch.nn.Module):
    ...
    def __init__(self, requires_grad=False, show_progress=False):
        super().__init__()
        vgg_pretrained_features = models.vgg16(weights = "DEFAULT", progress=show_progress).features
...
class Vgg19(torch.nn.Module):
    ...
    def __init__(self, requires_grad=False, show_progress=False, use_relu=True):
        super().__init__()
        vgg_pretrained_features = models.vgg19(weights= "DEFAULT", progress=show_progress).features
